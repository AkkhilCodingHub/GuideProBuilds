  ...
  if (!buildMethod && step === 1) {
    return (
      <div className="min-h-screen bg-transparent flex flex-col">
        <Navbar />
        <main className="flex-1 py-12 container mx-auto px-4 md:px-8 relative z-10">
                    ...
                    <TiltCard>
                      <Card 
                        className={`cursor-pointer border border-border/50 hover:border-cyan-500/30 transition-all duration-300 h-full hover:shadow-xl neon-glow-cyan-hover ${
                          formData.useCase === item.id ? "ring-2 ring-primary border-primary bg-primary/5" : "bg-card/50 backdrop-blur-sm"
                        }`}
                      ...
                      >
                        ...
                        <CardFooter className="justify-center">
                          <Button variant={formData.useCase === item.id ? "default" : "outline"} className="w-full pointer-events-none">
                  ...
                  <div className="space-y-6">
                    <Card className="border-primary/20 bg-primary/5">
                      ...
                      <CardFooter className="flex-col gap-3">
                        <Magnetic intensity={0.1} className="w-full">
