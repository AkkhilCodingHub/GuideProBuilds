...
import { 
  ...
  ChevronLeft, ChevronRight, AlertCircle, Check, X, CreditCard, RefreshCw
} from "lucide-react";
...
export default function Parts() {
  ...
  const syncMutation = useMutation({
    mutationFn: async () => {
      ...
      if (!res.ok) {
        throw new Error("Failed to synchronize with market catalog");
      }
    ...
    onSuccess: (data) => {
      ...
      toast({
        title: "Market Catalog Synchronized",
        description: data.message || "Successfully fetched the latest parts from the market!",
      });
    },
    onError: (error: any) => {
      toast({
        variant: "destructive",
        title: "Sync Failed",
        description: error.message || "Failed to synchronize parts. Please try again.",
      });
    }
  });
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col">
      ...
      <main className="flex-1 container py-8 px-4 md:px-8 relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  title="Sync with latest PC parts in the market"
                >
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-muted-foreground" suppressHydrationWarning>
                                ₹{item.part.price.toLocaleString('en-IN')}
                              </p>
                            </div>
                    ...
                    {cart && cart.itemCount > 0 && (
                      <div className="border-t pt-4 mt-4">
                        <div className="flex justify-between items-center text-lg font-bold">
                          <span>Total</span>
                          <span suppressHydrationWarning>₹{cart.total.toLocaleString('en-IN')}</span>
                        </div>
                        <Button 
              ...
              <>
                ...
                >
                  {partsData.parts.map((part) => (
                    <motion.div key={part._id} variants={itemVariants} className="h-full">
                      <TiltCard className="h-full">
                        <Card
                          className="overflow-hidden hover:border-cyan-500/30 transition-all duration-300 group neon-glow-cyan-hover h-full flex flex-col"
                        >
                        <CardHeader className="pb-2">
                      ...
                      <CardContent className="pb-2">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-2xl font-bold" suppressHydrationWarning>₹{part.price.toLocaleString('en-IN')}</span>
